...
import { TitleFindManyArgs } from "../../title/base/TitleFindManyArgs";
...
export class ProjectControllerBase {
  ...
  @common.Get("/:id/titles")
  @ApiNestedQuery(TitleFindManyArgs)
  async findManyTitles(
    @common.Req() request: Request,
    @common.Param() params: ProjectWhereUniqueInput
  ): Promise<Title[]> {
    const query = plainToClass(TitleFindManyArgs, request.query);
    const results = await this.service.findTitles(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/titles")
  async connectTitles(
    @common.Param() params: ProjectWhereUniqueInput,
    @common.Body() body: TitleWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      titles: {
        connect: body,
  ...
  @common.Delete("/:id/titles")
  async disconnectTitles(
    @common.Param() params: ProjectWhereUniqueInput,
    @common.Body() body: TitleWhereUniqueInput[]
  ): Promise<void> {
    const data = {
